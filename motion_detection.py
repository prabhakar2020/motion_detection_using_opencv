"""
Program for detecting the motion of the picture in live moment
@Author: Prabhakar Gadupudi
@Date: May 5, 2019
Description: OpenCV (Open Source Computer Vision) is a library of programming functions mainly designed for realtime computer vision and image processing
In simple language it is library used for Image Processing.
"""
import cv2
